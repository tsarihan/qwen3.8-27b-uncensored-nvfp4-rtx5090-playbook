#!/usr/bin/env python3
"""Verify a local NVFP4 snapshot against the publisher's HuggingFace LFS sha256 checksums.

Provenance is the only practical control over a quantized checkpoint: quantization
reprocesses every weight, and altered weights cannot be audited after the fact. Run this
before serving. Override with HF_REPO and LOCAL_DIR env vars.
"""
import hashlib, os, sys
from huggingface_hub import HfApi

REPO = os.environ.get("HF_REPO", "orcarouter/Qwen3.8-27B-Uncensored-NVFP4")
LOCAL = os.environ.get("LOCAL_DIR", os.path.expanduser("~/models/Qwen3.8-27B-Uncensored-NVFP4"))
